...
#define TERABYTES(V) (GIGABYTES(V) * 1024LL)
    ...
    // IMPORTANT(doug): Originally, these three macros defined different usages of
    // the keyword static as 'internal', 'local_persist' and 'global_variable'. I've
    ...
    // example, see line 64 of the C++ header file "c:/Program Files (x86)/Microsoft
    // Visual Studio 14.0/VC/include/xiosbase".
    //
